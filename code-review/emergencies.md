...
Sometimes there are emergency MRs that must pass through the entire code review
process as quickly as possible.


## What Is An Emergency?

An emergency MR would be a **small** change that: allows a major launch to
...
process, not just the [speed of response](reviewer-guide.md#speed-of-code-reviews). In this case
...
However, after the emergency is resolved you should look over the emergency MRs
again and give them a [more thorough review](reviewer-guide.md#what-to-look-for-in-a-code-review).
...
-   It is the end of the day on a Friday and it would just be great to get this
    MR in before the developer leaves for the weekend.
-   A manager says that this review has to be complete and the MR checked in
    today because of a [soft (not hard) deadline](#deadlines).
-   Rolling back a MR that is causing test failures or build breakages.
...
-   Submitting your MR by a certain date is necessary for a contractual
    obligation.
